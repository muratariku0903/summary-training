...
import { usersInAuth, userProfiles, seedGeneratorProfiles, exerciseGeneratorSeeds, llms, seedGeneratorThemes, idpLinks, exercises, exerciseGeneratorProfiles, seedGeneratorCategories, exerciseEvaluations, exerciseEvaluationDetails, exerciseSubmissions, exerciseGeneratorSources, exerciseGeneratorProfileSourcePatterns, exerciseGeneratorOutputConfigs, seedGeneratorThemeCategories, exerciseGeneratorSourceSeeds, exerciseGeneratorProfileSources, exerciseGeneratorOutputConfigsSchemas } from "./schema";
...
export const exerciseGeneratorSeedsRelations = relations(exerciseGeneratorSeeds, ({one, many}) => ({
...
export const seedGeneratorProfilesRelations = relations(seedGeneratorProfiles, ({many}) => ({
...
export const seedGeneratorThemesRelations = relations(seedGeneratorThemes, ({many}) => ({
	exerciseGeneratorSeeds: many(exerciseGeneratorSeeds),
...
export const exerciseGeneratorProfilesRelations = relations(exerciseGeneratorProfiles, ({one, many}) => ({
	exercises: many(exercises),
...
export const seedGeneratorCategoriesRelations = relations(seedGeneratorCategories, ({one, many}) => ({
...
export const exerciseEvaluationDetailsRelations = relations(exerciseEvaluationDetails, ({one}) => ({
...
export const exerciseEvaluationsRelations = relations(exerciseEvaluations, ({one, many}) => ({
...
export const exerciseSubmissionsRelations = relations(exerciseSubmissions, ({one, many}) => ({
...
export const exerciseGeneratorSourcesRelations = relations(exerciseGeneratorSources, ({one, many}) => ({
	seedGeneratorTheme: one(seedGeneratorThemes, {
...
export const exerciseGeneratorProfileSourcePatternsRelations = relations(exerciseGeneratorProfileSourcePatterns, ({one}) => ({
	exerciseGeneratorProfile: one(exerciseGeneratorProfiles, {
...
export const exerciseGeneratorOutputConfigsRelations = relations(exerciseGeneratorOutputConfigs, ({one, many}) => ({
	llm: one(llms, {
...
export const seedGeneratorThemeCategoriesRelations = relations(seedGeneratorThemeCategories, ({one}) => ({
	seedGeneratorCategory: one(seedGeneratorCategories, {
...
export const exerciseGeneratorSourceSeedsRelations = relations(exerciseGeneratorSourceSeeds, ({one}) => ({
...
export const exerciseGeneratorProfileSourcesRelations = relations(exerciseGeneratorProfileSources, ({one}) => ({
	exerciseGeneratorProfile: one(exerciseGeneratorProfiles, {
...
export const exerciseGeneratorOutputConfigsSchemasRelations = relations(exerciseGeneratorOutputConfigsSchemas, ({one}) => ({
	llm: one(llms, {
